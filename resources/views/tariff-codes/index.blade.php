...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1><i class="fas fa-list-alt"></i> Partidas Arancelarias</h1>
                    <p class="text-muted">Consulta de {{ $tariffCodes->total() }} partidas arancelarias activas</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('tariff-codes.index') }}">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('tariff-codes.index') }}" class="btn btn-outline-secondary">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('tariff-codes.show', $tariffCode->hs_code) }}"
