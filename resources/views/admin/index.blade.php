                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fas fa-check text-success"></i> Códigos Liberatorios SENAE (IVA 0% / Arancel)</li>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('admin.liberations.index') }}" class="btn btn-outline-primary btn-lg w-100">
                                <i class="fas fa-file-contract"></i><br>
                                Códigos Liberatorios SENAE
                            </a>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('admin.tariff-codes') }}" class="btn btn-outline-dark btn-lg w-100">
                        ...
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('admin.clear-cache') }}" class="btn btn-outline-danger btn-lg w-100">
